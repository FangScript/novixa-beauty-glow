...
-- CreateEnum
CREATE TYPE "ProductCategory" AS ENUM ('PERFUME', 'MAKEUP', 'GROOMING', 'BUNDLE', 'ACCESSORIES');
...
-- CreateEnum
CREATE TYPE "PaymentStatus" AS ENUM ('UNPAID', 'REQUIRES_ACTION', 'AUTHORIZED', 'PAID', 'FAILED', 'REFUNDED');
