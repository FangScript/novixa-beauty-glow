...
export default function NotFound() {
  return (
    <div className="min-h-[70vh] flex flex-col items-center justify-center text-center px-4 py-20">
      ...
      <h1 className="mt-3 font-display text-5xl md:text-6xl text-foreground">Lost in Luxury</h1>
      <p className="mt-4 max-w-md text-sm text-muted-foreground leading-relaxed">
        The fragrance or page you are looking for does not exist or has been relocated to another
        collection.
      </p>
      <Button
        asChild
